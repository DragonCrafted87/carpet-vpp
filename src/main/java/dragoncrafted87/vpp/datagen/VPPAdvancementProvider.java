...
public class VPPAdvancementProvider extends FabricAdvancementProvider {
    ...
    public void generateAdvancement(RegistryWrapper.WrapperLookup registryLookup, Consumer<AdvancementEntry> consumer) {
        ...
        Advancement.Builder.createUntelemetered()
                ...
                .rewards(AdvancementRewards.Builder.recipe(RegistryKey.of(RegistryKeys.RECIPE, Identifier.of("vpp", "pouch"))))
                ...
                .criterion("has_the_recipe", RecipeUnlockedCriterion.create(RegistryKey.of(RegistryKeys.RECIPE, Identifier.of("vpp", "pouch"))))
        ...
        Advancement.Builder.createUntelemetered()
                .parent(new AdvancementEntry(Identifier.of("minecraft", "recipes/root"), null))
                .rewards(AdvancementRewards.Builder.recipe(RegistryKey.of(RegistryKeys.RECIPE, Identifier.of("vpp", "satchel_strap"))))
                .criterion("has_leather", InventoryChangedCriterion.Conditions.items(Items.LEATHER))
                .criterion("has_string", InventoryChangedCriterion.Conditions.items(Items.STRING))
                .criterion("has_the_recipe", RecipeUnlockedCriterion.create(RegistryKey.of(RegistryKeys.RECIPE, Identifier.of("vpp", "satchel_strap"))))
                .requirements(AdvancementRequirements.allOf(List.of("has_leather", "has_string", "has_the_recipe")))
                .build(consumer, "vpp:satchel_strap");

        Advancement.Builder.createUntelemetered()
                .parent(new AdvancementEntry(Identifier.of("minecraft", "recipes/root"), null))
                .rewards(AdvancementRewards.Builder.recipe(RegistryKey.of(RegistryKeys.RECIPE, Identifier.of("vpp", "satchel"))))
                .criterion("has_satchel_strap", InventoryChangedCriterion.Conditions.items(MinecraftVPP.SATCHEL_STRAP))
                .criterion("has_leather", InventoryChangedCriterion.Conditions.items(Items.LEATHER))
                .criterion("has_string", InventoryChangedCriterion.Conditions.items(Items.STRING))
                .criterion("has_button", InventoryChangedCriterion.Conditions.items(Items.STONE_BUTTON))
                .criterion("has_the_recipe", RecipeUnlockedCriterion.create(RegistryKey.of(RegistryKeys.RECIPE, Identifier.of("vpp", "satchel"))))
        ...
        Advancement.Builder.createUntelemetered()
                .parent(new AdvancementEntry(Identifier.of("minecraft", "recipes/root"), null))
                .rewards(AdvancementRewards.Builder.recipe(RegistryKey.of(RegistryKeys.RECIPE, Identifier.of("vpp", "upgraded_pouch"))))
                ...
                .criterion("has_the_recipe", RecipeUnlockedCriterion.create(RegistryKey.of(RegistryKeys.RECIPE, Identifier.of("vpp", "upgraded_pouch"))))
        ...
        Advancement.Builder.createUntelemetered()
                .parent(new AdvancementEntry(Identifier.of("minecraft", "recipes/root"), null))
                .rewards(AdvancementRewards.Builder.recipe(RegistryKey.of(RegistryKeys.RECIPE, Identifier.of("vpp", "upgraded_satchel"))))
                .criterion("has_diamond", InventoryChangedCriterion.Conditions.items(Items.DIAMOND))
                .criterion("has_leather", InventoryChangedCriterion.Conditions.items(Items.LEATHER))
                .criterion("has_satchel", InventoryChangedCriterion.Conditions.items(MinecraftVPP.SATCHEL))
                .criterion("has_the_recipe", RecipeUnlockedCriterion.create(RegistryKey.of(RegistryKeys.RECIPE, Identifier.of("vpp", "upgraded_satchel"))))
